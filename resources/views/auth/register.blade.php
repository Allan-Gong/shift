                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="date" placeholder="dd/mm/yyyy" class="form-control" name="date_of_birth" value="{{ old('date_of_birth') }}">
                        ...
                        <div class="form-group{{ $errors->has('workplace') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Workplace</label>
